...
public class MainPageServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -3998876322920060188L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user == null) {
			...
			RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/main.jsp");
